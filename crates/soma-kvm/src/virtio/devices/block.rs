...
use request::{
    BlockOp, BlockRequest, MAX_REQUEST_BYTES, REQUEST_HEADER_LEN, RequestError, RequestLimits,
    SECTOR_SIZE, VIRTIO_BLK_S_IOERR, VIRTIO_BLK_S_OK, parse_request,
};
...
impl BlockDevice {
    ...
    fn count(&mut self, status: u8, error: Option<RequestError>) {
