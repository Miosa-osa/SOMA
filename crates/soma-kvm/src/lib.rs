...
pub use virtio::{
    ...
    NotifySource, PacketError, PendingWork, QUEUE_STATE_LEN, Queue, QueueLayout, QueueState,
    ...
    RngState, SECTOR_SIZE, SLOT_COUNT, SOMA_CONTROL_PORT, SOMA_VENDOR_ID, ServiceError,
    ServiceReport, Slot, SlotRestoreError, SlotSnapshot, StatusViolation, StatusWrite,
