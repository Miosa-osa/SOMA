...
pub use virtio::{
    ...
    DescriptorChain, DeviceFault, DeviceSet, DeviceStateError, DeviceStatus, EntropyBackend,
    EntropyError, FIRST_GSI, FrameError, GuestAddress, GuestMemory, GuestMemoryError, GuestValue,
    HOST_BUF_ALLOC, HOST_CID, HOST_TX_BUFFER, HostEndpoint, INTERRUPT_CONFIG_CHANGE,
    INTERRUPT_USED_BUFFER, IrqSink, LOOPBACK_QUEUE_LIMIT, LayoutViolation, LoopbackBackend,
    LoopbackHandle, MAX_CONFIG_LEN, MAX_ENTROPY_REQUEST, MAX_FRAME_LEN, MAX_OUTBOUND_PACKETS,
    MAX_PAYLOAD_LEN, MAX_PENDING_EVENTS, MAX_QUEUE_SIZE, MAX_QUEUES, MAX_REQUEST_BYTES,
    MAX_RX_CHAIN_BYTES, MIN_FRAME_LEN, MIN_GUEST_CID, MMIO_PAGE_SIZE, MMIO_WINDOW_BASE,
    MemoryBackend, MmioBus, MmioTransport, NET_CONFIG_LEN, NET_FEATURES, NET_QUEUE_MAX,
    NET_RX_QUEUE, NET_STATE_LEN, NET_STATE_VERSION, NET_TX_QUEUE, NetBackend, NetBackendError,
    NetCounters, NetDevice, NetState, NotifySource, PacketError, PendingWork, QUEUE_STATE_LEN,
    Queue, QueueLayout, QueueState, QueueStateError, QueueViolation, QueueViolationCounters,
    QueueViolationKind, REQUEST_HEADER_LEN, RNG_FEATURES, RNG_QUEUE_MAX, RNG_STATE_LEN,
    ...
    VSOCK_FEATURES, VSOCK_HDR_LEN, VSOCK_OP_CREDIT_REQUEST, VSOCK_OP_CREDIT_UPDATE,
    VSOCK_OP_INVALID, VSOCK_OP_REQUEST, VSOCK_OP_RESPONSE, VSOCK_OP_RST, VSOCK_OP_RW,
    VSOCK_OP_SHUTDOWN, VSOCK_QUEUE_MAX, VSOCK_RX_QUEUE, VSOCK_SHUTDOWN_RCV, VSOCK_SHUTDOWN_SEND,
    VSOCK_STATE_LEN, VSOCK_STATE_VERSION, VSOCK_TX_QUEUE, VSOCK_TYPE_STREAM, VecGuestMemory,
    VirtioDevice, VsockConfigError, VsockCounters, VsockDevice, VsockHeader, VsockState,
    deliver_events, deliver_rx, deliver_vsock_rx, kernel_command_line, parse_request, parse_tx,
    read_readable, service_queue, validate_size, validate_tx, walk_chain, write_writable,
};
