...
- **Published claim:** **Vendor claim.** The API reference contains an illustrative create response with `create_ms: 9`, which is an example payload rather than an independently measured result.
