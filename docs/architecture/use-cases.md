...
| `soma-generation` | Future OCI resolution, conversion, snapshot capture, certification, and compatibility metadata |
| `soma-protocol` | Future bounded canonical wire values shared by local and remote transports |
| `soma-guest` | Future minimal authenticated guest control and repair protocol |
